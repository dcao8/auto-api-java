...
public class ConstantUtils {
    ...
    public static final String HEADER_POWER_BY = "X-Powered-By";
    public static final String CONTENT_TYPE = "application/json; charset=utf-8";
    public static final String POWER_BY = "Express";
    public static final String EMAIL_TEMPLATE = "api_%s@api.com";
